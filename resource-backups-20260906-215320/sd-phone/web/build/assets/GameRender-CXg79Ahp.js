...
`,On=16,kn=1,An=60,jn=class{renderer;material;sceneRTT;cameraRTT;rtTexture;canvas=null;animated=!1;pump=null;pumpMs=On;pixels=null;image=null;ctx=null;bufW=0;bufH=0;frames=0;zoom=1;orientation=`portrait`;selfie=!1;constructor(){let e=new P;e.needsUpdate=!0,this.material=new we({uniforms:{tDiffuse:{value:e}},vertexShader:En,fragmentShader:Dn}),this.cameraRTT=this.buildCamera(!0),this.sceneRTT=this.buildScene(),this.rtTexture=this.buildTarget(),this.renderer=new Tn,this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.autoClear=!1;let t=document.createElement(`div`);t.id=`three-game-render`,t.style.display=`none`,t.appendChild(this.renderer.domElement),document.body.append(t),window.addEventListener(`resize`,()=>this.rebuild(!this.animated))}renderToTarget(e){this.rebuild(!1),this.canvas=e,this.animated=!0,this.bufW=0,this.bufH=0,this.startPump()}setTargetFps(e){let t=Math.max(1,Math.round(1e3/Math.round(Math.min(An,Math.max(kn,e||An)))));t!==this.pumpMs&&(this.pumpMs=t,this.pump!==null&&this.startPump())}framesRendered(){return this.frames}startPump(){this.pump!==null&&clearInterval(this.pump),this.pump=setInterval(this.animate,this.pumpMs)}setZoom(e){this.zoom=e>0?e:1,this.animated&&this.rebuild(!1)}setOrientation(e){this.orientation=e,this.animated&&this.rebuild(!1)}setSelfie(e){this.selfie=e,this.animated&&this.rebuild(!1)}stop(){this.animated=!1,this.canvas=null,this.pump!==null&&(clearInterval(this.pump),this.pump=null),this.rebuild(!0)}buildCamera(n){let r=window.innerWidth,i=window.innerHeight,a=new ge(r/-2,r/2,i/2,i/-2,-1e4,1e4);if(a.position.z=0,n)a.setViewOffset(r,i,0,0,r,i);else{let n=this.selfie?e:0,o=t(r,i,this.zoom,this.orientation,n);a.setViewOffset(r,i,o.offsetX,o.offsetY,o.width,o.height)}return a}buildScene(){let e=new xe,t=new me(new be(window.innerWidth,window.innerHeight),this.material);return t.position.z=-100,e.add(t),e}buildTarget(){return new Te(window.innerWidth,window.innerHeight,{minFilter:s,magFilter:o,format:m,type:l})}rebuild(e){this.cameraRTT=this.buildCamera(e),this.sceneRTT=this.buildScene(),this.rtTexture=this.buildTarget(),this.renderer.setSize(window.innerWidth,window.innerHeight)}animate=()=>{if(!this.animated||!this.canvas)return;let e=window.innerWidth,t=window.innerHeight;if(!(e<=0||t<=0)){if(this.bufW!==e||this.bufH!==t||!this.pixels||!this.image||!this.ctx){this.bufW=e,this.bufH=t;let n=new ArrayBuffer(e*t*4);if(this.pixels=new Uint8Array(n),this.image=new ImageData(new Uint8ClampedArray(n),e,t),this.canvas.width=e,this.canvas.height=t,this.ctx=this.canvas.getContext(`2d`),!this.ctx)return}this.renderer.clear(),this.renderer.render(this.sceneRTT,this.cameraRTT,this.rtTexture,!0),this.renderer.readRenderTargetPixels(this.rtTexture,0,0,e,t,this.pixels),this.ctx.putImageData(this.image,0,0),this.frames+=1}}};export{jn as GameRender};