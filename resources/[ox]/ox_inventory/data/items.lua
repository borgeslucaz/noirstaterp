...
["blueprint_advancedlockpick"] = {
    ...
    -- advance-mechanic
    ['toolbox'] = { label = 'Toolbox', weight = 3500, stack = false, close = true, description = 'Portable mechanic toolbox.' },
    ['diagnostic_tool'] = { label = 'Diagnostic Tool', weight = 1500, stack = false, close = true, description = 'Electronic vehicle diagnostic scanner.' },
    ['toolkit'] = { label = 'Mechanic Toolkit', weight = 2500, stack = false, close = true, description = 'Basic mechanic toolkit.' },
    ['engine_oil'] = { label = 'Engine Oil', weight = 1000, stack = true, close = true, description = 'Engine oil for routine maintenance.' },
    ['transmission_fluid'] = { label = 'Transmission Fluid', weight = 1000, stack = true, close = true, description = 'Transmission service fluid.' },
    ['suspension_parts'] = { label = 'Suspension Parts', weight = 4000, stack = true, close = true },
    ['engine_part'] = { label = 'Engine Part', weight = 3500, stack = true, close = true },
    ['brake_part'] = { label = 'Brake Part', weight = 2500, stack = true, close = true },
    ['transmission_part'] = { label = 'Transmission Part', weight = 4000, stack = true, close = true },
    ['suspension_part'] = { label = 'Suspension Part', weight = 3500, stack = true, close = true },
    ['power_steering_fluid'] = { label = 'Power Steering Fluid', weight = 1000, stack = true, close = true },
    ['car_door'] = { label = 'Car Door', weight = 12000, stack = true, close = true },
    ['car_hood'] = { label = 'Car Hood', weight = 14000, stack = true, close = true },
    ['car_trunk'] = { label = 'Car Trunk', weight = 14000, stack = true, close = true },
    ['car_wheel'] = { label = 'Car Wheel', weight = 9000, stack = true, close = true },
    ['car_window'] = { label = 'Car Window', weight = 6000, stack = true, close = true },
    ['car_bumper'] = { label = 'Car Bumper', weight = 9000, stack = true, close = true },
    ['wrench'] = { label = 'Wrench', weight = 1000, stack = false, close = true },
    ['hydraulic_jack'] = { label = 'Hydraulic Jack', weight = 12000, stack = false, close = true },
    ['tow_rope'] = { label = 'Tow Rope', weight = 4000, stack = false, close = true },
    ['motor_mount_i4'] = { label = 'I4 Motor Mount', weight = 5000, stack = true, close = true },
    ['motor_mount_v6'] = { label = 'V6 Motor Mount', weight = 6000, stack = true, close = true },
    ['motor_mount_v8'] = { label = 'V8 Motor Mount', weight = 7000, stack = true, close = true },
    ['ecu_adapter'] = { label = 'ECU Adapter', weight = 800, stack = true, close = true },
    ['i4_stock'] = { label = 'Stock I4 Engine', weight = 120000, stack = false, close = true },
    ['i4_turbo'] = { label = 'Turbo I4 Engine', weight = 135000, stack = false, close = true },
    ['v6_stock'] = { label = 'Stock V6 Engine', weight = 160000, stack = false, close = true },
    ['v6_turbo'] = { label = 'Twin-Turbo V6 Engine', weight = 175000, stack = false, close = true },
    ['v8_stock'] = { label = 'Stock V8 Engine', weight = 180000, stack = false, close = true },
    ['v8_ls3'] = { label = 'LS3 V8 Engine', weight = 185000, stack = false, close = true },
    ['vehicledoor_lf'] = { label = 'Left Front Door', weight = 12000, stack = true, close = true, description = 'A left front vehicle door' },
    ['vehicledoor_rf'] = { label = 'Right Front Door', weight = 12000, stack = true, close = true, description = 'A right front vehicle door' },
    ['vehicledoor_lr'] = { label = 'Left Rear Door', weight = 12000, stack = true, close = true, description = 'A left rear vehicle door' },
    ['vehicledoor_rr'] = { label = 'Right Rear Door', weight = 12000, stack = true, close = true, description = 'A right rear vehicle door' },
    ['vehiclehood'] = { label = 'Vehicle Hood', weight = 14000, stack = true, close = true, description = 'A vehicle hood' },
    ['vehicletrunk'] = { label = 'Vehicle Trunk', weight = 14000, stack = true, close = true, description = 'A vehicle trunk' },
    ['vehiclewheel_lf'] = { label = 'Left Front Wheel', weight = 9000, stack = true, close = true, description = 'A left front vehicle wheel' },
    ['vehiclewheel_rf'] = { label = 'Right Front Wheel', weight = 9000, stack = true, close = true, description = 'A right front vehicle wheel' },
    ['vehiclewheel_lr'] = { label = 'Left Rear Wheel', weight = 9000, stack = true, close = true, description = 'A left rear vehicle wheel' },
    ['vehiclewheel_rr'] = { label = 'Right Rear Wheel', weight = 9000, stack = true, close = true, description = 'A right rear vehicle wheel' },
}
