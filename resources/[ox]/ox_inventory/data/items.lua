return {
    ['xs_tablet'] = {
        label = 'XS Criminal Tablet',
        weight = 750,
        stack = false,
        close = true,
        consume = 0,
        description = 'Tablet criptografado para operacoes criminosas.',
    ...
    ['illegal_box'] = {
        ...
        close = true,
        consume = 0,
        description = 'Carga clandestina lacrada para transporte.',
        client = { image = 'mail_package.png' },
    },
...
["blueprint_advancedlockpick"] = {
    ...
    ['pistol_slide'] = { label = 'Pistol Slide', rarity = 'uncommon', weight = 300 },
    ['pistol_trigger'] = { label = 'Pistol Trigger', rarity = 'uncommon', weight = 100 },
    ['pistol_grip'] = { label = 'Pistol Grip', rarity = 'uncommon', weight = 200 },

    ['pistol_blueprint'] = { label = 'Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Pistol' },
    ['combatpistol_blueprint'] = { label = 'Combat Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Combat Pistol' },
    ['pistol50_blueprint'] = { label = 'Pistol .50 Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Pistol .50' },
    ['snspistol_blueprint'] = { label = 'SNS Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting SNS Pistol' },
    ['heavypistol_blueprint'] = { label = 'Heavy Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Heavy Pistol' },
    ['vintagepistol_blueprint'] = { label = 'Vintage Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Vintage Pistol' },
    ['appistol_blueprint'] = { label = 'AP Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting AP Pistol' },
    ['microsmg_blueprint'] = { label = 'Micro SMG Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Micro SMG' },
    ['smg_blueprint'] = { label = 'SMG Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting SMG' },
    ['assaultsmg_blueprint'] = { label = 'Assault SMG Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Assault SMG' },
    ['combatpdw_blueprint'] = { label = 'Combat PDW Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Combat PDW' },
    ['assaultrifle_blueprint'] = { label = 'Assault Rifle Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Assault Rifle' },
    ['carbinerifle_blueprint'] = { label = 'Carbine Rifle Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Carbine Rifle' },
    ['advancedrifle_blueprint'] = { label = 'Advanced Rifle Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Advanced Rifle' },
    ['specialcarbine_blueprint'] = { label = 'Special Carbine Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Special Carbine' },
    ['bullpuprifle_blueprint'] = { label = 'Bullpup Rifle Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Bullpup Rifle' },
    ['pumpshotgun_blueprint'] = { label = 'Pump Shotgun Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Pump Shotgun' },
    ['sawnoffshotgun_blueprint'] = { label = 'Sawed-Off Shotgun Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Sawed-Off Shotgun' },
    ['ammo9_blueprint'] = { label = '9mm Ammo Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting 9mm Ammo' },
    ['ammo45_blueprint'] = { label = '.45 ACP Ammo Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting .45 ACP Ammo' },
    ['ammorifle_blueprint'] = { label = 'Rifle Ammo Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Rifle Ammo' },
    ['ammoshotgun_blueprint'] = { label = 'Shotgun Shells Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Shotgun Shells' },
    ['ammosniper_blueprint'] = { label = 'Sniper Ammo Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Sniper Ammo' },
    ['basic_tools_blueprint'] = { label = 'Basic Tools Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting lockpicks' },
    ['medical_basic_blueprint'] = { label = 'Basic Medical Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting bandages' },
    ['mechanical_blueprint'] = { label = 'Mechanical Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting repair kits' },
    ['machinepistol_blueprint'] = { label = 'Machine Pistol Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Machine Pistol' },
    ['minismg_blueprint'] = { label = 'Mini SMG Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Mini SMG' },
    ['compactrifle_blueprint'] = { label = 'Compact Rifle Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Compact Rifle' },
    ['assaultshotgun_blueprint'] = { label = 'Assault Shotgun Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Assault Shotgun' },
    ['bullpupshotgun_blueprint'] = { label = 'Bullpup Shotgun Blueprint', weight = 10, stack = false, close = true, description = 'Blueprint for crafting Bullpup Shotgun' },
