...
---Se quem revista pode tirar o item deste slot: roupa so com stealable.
---@param slot any
---@return boolean
function Equipment.canTakeFromOther(slot)
	local def = bySlot[slot]
	return not def or def.group ~= 'clothing' or def.stealable == true
end
