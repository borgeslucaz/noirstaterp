# Contributing to Noir Truckjob

Thank you for your interest in improving Noir Truckjob! This document explains how to contribute effectively.
...
```powershell
# Clone your fork
git clone https://github.com/<your-username>/noir-truckjob.git
...
Place the resource folder as `noir-truckjob` in your FiveM server's `resources/` directory and ensure it in `server.cfg`.
