...
### Senior Engineer Prompt for `noir-truckjob` Integration

**Context:**
You are a Senior FiveM Developer. I have installed the `noir-truckjob` resource, a full-featured trucking job with driver progression, company trust, daily missions, leaderboards, optional illegal cargo, and a React-based NUI dispatch tablet. I need you to configure it to match my server's environment perfectly.
...
- Import [install/install.sql](install/install.sql) into my database to create the `noir_truckjob` table.
