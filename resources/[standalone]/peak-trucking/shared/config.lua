...
-- Missões diárias, mercado global, economia e RouteMeta: shared/contract_config.lua
...
-- XP por entrega é determinístico (Config.RouteMeta[...].baseXP × nota). Ver shared/contract_config.lua
