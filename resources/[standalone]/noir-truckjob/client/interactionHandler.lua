            ...
            options = {
                {
                    ...
                    icon = 'fas fa-gears',
                    label = L('open_menu'),
                    action = function() TriggerEvent('noir-truckjob:OpenMenu') end,
                }
            },
            distance = 3.5,
        })
    ...
    CreateThread(function()
        ...
        while true do
            ...
            if dist < 5.0 then
                ...
                if IsControlJustPressed(0, 38) then TriggerEvent('noir-truckjob:OpenMenu') end
