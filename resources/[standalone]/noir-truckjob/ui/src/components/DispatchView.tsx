...
function ContractRow({
  ...
  const beginnersOnly = false
  const bandLabel = `${t('level', 'Nível')} ${offer.reqLevel}+`
    ...
    >
      ...
      <div className="contract-row__body">
        ...
        <small className="contract-row__meta">
          ...
          <span>{offer.cargoType} · {offer.estimatedMinutes} {t('minutes_short', 'min')}</span>
      ...
      <div className="reward-summary">
        ...
        {offer ? (
          <p className="reward-summary__subtitle">
            ...
            {offer.reqLevel ? ` · ${t('lock_mission_level', 'Nível %s necessário', offer.reqLevel)}` : ''}
          </p>
        ) : null}
