Shared = {
    ...
    steal = {
        ...
        getKey = "none", -- assalto nao da chave: o carro sai ligado e marcado como ligacao direta
        label = "Assaltando...",
        minTime = 5000,
        maxTime = 7000,
    ...
    grab = {
        ...
        alive = true,
        leaveKeysOnVehicle = true, -- carro sai ligado e marcado como ligacao direta (sem chave)
