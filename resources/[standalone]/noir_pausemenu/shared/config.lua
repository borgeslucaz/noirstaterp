...
-- Called when photomode starts. Hide HUD and other UIs from external resources here.
-- Example:
--   exports['hud']:HideHud()
--   exports['ox_inventory']:closeInventory()
Config.OnPhotomodeEnter = function()
end

-- Called when photomode ends (returning to pause menu or closing).
-- Use exports['noir_pausemenu']:IsPauseMenuOpen() if HUD should stay hidden when returning to pause menu.
-- Example:
--   if not exports['noir_pausemenu']:IsPauseMenuOpen() then
--       exports['hud']:ShowHud()
--   end
Config.OnPhotomodeExit = function()
end

-- Pause camera (on foot)
Config.PauseCameraDistance = 2.0
Config.PauseCameraHeight = 0.3
Config.PauseCameraFov = 42.0
Config.PauseCameraTransitionMs = 800
Config.PauseCameraRefreshMs = 200 -- How often (ms) the pause camera refreshes its position/blur. Higher = less CPU

-- Pause camera (in vehicle) — araca bindiğinde kameranın ne kadar uzaklaşacağı
Config.PauseCameraVehicleDistance = 3.5
Config.PauseCameraVehicleHeight = 0.5
Config.PauseCameraVehicleFov = 48.0

-- Photomode camera
Config.RotateStep = 25.0
Config.CameraRotateDurationMs = 450
Config.PhotomodeDragSensitivity = 0.35
Config.PhotomodeHeightSensitivity = 0.004
Config.PhotomodeZoomSpeed = 0.18
Config.PhotomodeMinDistance = 1.0
Config.PhotomodeMaxDistance = 8.0
Config.PhotomodeMinHeight = -0.8
Config.PhotomodeMaxHeight = 2.5
Config.PhotomodeIdleRefreshMs = 100 -- Camera refresh while idle; movement still updates every frame

-- Depth-of-field blur (background behind character)
Config.PauseMenuBlur = true
Config.PhotomodeBlur = true
Config.BlurStrength = 1.0
Config.BlurFocalMultiplier = 50.0
Config.BlurFocusPadding = 0.2

-- Character animations: 'single' = always same anim | 'random' = random idle each open
...
Config.SingleAnimation = {
    male = { dict = 'amb@world_human_hang_out_street@male_a@idle_a', anim = 'idle_a' },
    female = { dict = 'amb@world_human_hang_out_street@female_hold_arm@idle_a', anim = 'idle_a' },
}
