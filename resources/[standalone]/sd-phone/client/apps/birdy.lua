...
proxyCallback('sd-phone:birdy:verificationOffer',    'sd-phone:server:birdy:verificationOffer')
proxyCallback('sd-phone:birdy:purchaseVerification', 'sd-phone:server:birdy:purchaseVerification')
