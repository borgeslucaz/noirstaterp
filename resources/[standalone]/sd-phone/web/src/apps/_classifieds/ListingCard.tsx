...
export function ListingCard({ item, subject, onOpen, onMessage, onCall, onEmail, onDelete }: {
    ...
    return (
        <div
            ...
            className={`rounded-[16px] bg-surface px-5 py-4 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-black/[0.04] dark:shadow-none dark:ring-white/[0.06] ${onOpen ? 'cursor-pointer transition-colors duration-150 hover:bg-[#dadada] active:bg-[#d2d2d2] dark:hover:bg-[#262628] dark:active:bg-[#2e2e30]' : ''}`}
        >
