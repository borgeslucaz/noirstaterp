...
local function streamFor(liveId)
    ...
    return media.streamId('photogram', 'live', liveId)
end
...
---what carried the account check and the host's privacy check. Nil refuses, and the phone falls
---back to the event relay it never stopped listening on.
