...
![noir_hud](https://github.com/user-attachments/assets/02225904-50ac-4258-b08c-ec54495b875e)
...
exports['noir_hud']:toggleHud(state) -- toggle HUD visiblity.
exports['noir_hud']:toggleMap(state) -- toggle minimap visibility.
```
...
I welcome contributions to improve noir_hud, it would not be possible to maintain without the community. If you'd like to help enhance the resource, feel free to use discussions, open issues, or submit pull requests.  
