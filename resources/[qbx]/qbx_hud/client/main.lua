...
RegisterNetEvent('hud:client:LoadMap', function()
    Wait(50)
    if GetResourceState('mnr_minimap') == 'started' then
        sharedConfig.menu.isToggleMapShapeChecked = 'square'
        showCircleB = false
        showSquareB = sharedConfig.menu.isToggleMapBordersChecked
        SendNUIMessage({test = true, event = 'isToggleMapShapeChecked', toggle = 'square'})
        return
    end
