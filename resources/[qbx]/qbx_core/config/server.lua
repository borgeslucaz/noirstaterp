return {
    ...
    money = {
        ...
        paycheckEnabled = false, -- Enable or disable automatic job paychecks
    ...
    server = {
        ...
        checkDuplicateLicense = false, -- Check for duplicate rockstar license on join TODO: COME BACK TO FALSE ON PROD
