...
const SelectTattoo = ({
  ...
  customStyles.menu.background = `rgba(0, 0, 0, 0.8)`;
  customStyles.menuList.background = `rgba(0, 0, 0, 0.8)`;

  return (
    <div className="select-tattoo-container">
      <Select
        ref={selectRef}
        styles={customStyles}
