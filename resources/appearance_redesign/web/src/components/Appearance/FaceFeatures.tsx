...
const FaceFeatures = ({ settings, storedData, data, handleFaceFeatureChange }: FaceFeaturesProps) => {
  ...
  return (
    <div className="face-features-container">
      <div className="item">
        <h1>{locales.faceFeatures.nose.title}</h1>
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.eyebrows.title}</h1>
        <RangeInput
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.cheeks.title}</h1>
        <RangeInput
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.eyesAndMouth.title}</h1>
        <RangeInput
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.jaw.title}</h1>
        <RangeInput
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.chin.title}</h1>
        <RangeInput
      ...
      <div className="item2">
        <h1>{locales.faceFeatures.neck.title}</h1>
        <RangeInput
